...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "TouristTeam", withExtension: "momd")!
    ...
    func preloadDataFromFile() {
        ...
        do {
            ...
            for row in csvRows! {
                ...
                activity.name           =        row[0]
                activity.latitude       = Double(row[1])!
                activity.longitude      = Double(row[2])!
                activity.information    =        row[3]
                activity.link           =        row[4]
    ...
    func removeData() {
        ...
        do {
            let activities = try managedObjectContext.fetch(fetchRequest) as! [Activity]
